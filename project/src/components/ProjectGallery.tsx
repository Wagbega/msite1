          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project) => (
              <div
                ...
                className="group cursor-pointer rounded-lg overflow-hidden bg-gray-100 shadow-md hover:shadow-xl transition-shadow duration-300"
              >
                ...
                <div className="p-6">
                  <span className="inline-block text-xs font-semibold text-blue-600 uppercase mb-2">
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700 capitalize">{selectedProject.service_type}</p>
                </div>
                <div>
