    ...
    <section id="contact" className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 outline-none transition resize-none"
              />
            </div>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600 mb-1">Project Complexity</p>
            <p className="text-2xl font-bold text-gray-900">Any Size</p>
          </div>
          <div className="text-center">
